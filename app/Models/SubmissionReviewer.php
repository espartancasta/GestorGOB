...
class SubmissionReviewer extends Model
{
    ...
    public function reviewDecisionKey(): string
    {
        if ($this->status !== 'completed') {
            return 'en_revision';
        }

        return $this->review_decision ?: 'en_revision';
    }

    public function reviewDecisionLabel(): string
    {
        return match ($this->reviewDecisionKey()) {
            'aprobado' => 'Aprobado',
    ...
    public function reviewDecisionClass(): string
    {
        return match ($this->reviewDecisionKey()) {
