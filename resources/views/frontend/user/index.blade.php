...
<div class="container" style="padding-top:120px; padding-bottom:40px;">
    <div class="row">
        <div class="col-lg-8 mx-auto">
            ...
            <div class="card" style="border-radius:16px; border:1px solid #e5e5e5;">
                <div class="card-body" style="padding:28px;">

                    {{-- HEADER --}}
                    <div class="d-flex align-items-center" style="gap:18px; margin-bottom:15px;">

                        <img src="{{ asset('assets/frontend/img/default-avatar.svg') }}"
                             alt="avatar"
                             style="width:88px;height:88px;border-radius:50%;object-fit:cover;border:1px solid #ddd;">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <p><strong>Registro:</strong> {{ optional($user->created_at)->format('d/m/Y') }}</p>
                        </div>
                    </div>
